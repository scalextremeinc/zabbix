...
int CONFIG_HISTSYNCER_TRENDS_FORKS = 1;
int CONFIG_HISTSYNCER_ANALYZER_UPTIMES_FORKS = 1;
int	CONFIG_HISTSYNCER_TRENDS_FREQUENCY = 3;
int	CONFIG_HISTSYNCER_ANALYZER_UPTIMES_FREQUENCY = 10;
...
int	CONFIG_TRENDS_DB_CACHE_SIZE	= 4 * ZBX_MEBIBYTE;
int CONFIG_ANALYZER_AVAIL_UPTIMES_CACHE_SIZE = 2 * ZBX_MEBIBYTE;
int CONFIG_ANALYZER_AVAIL_PINGS_CACHE_SIZE = 2 * ZBX_MEBIBYTE;
int CONFIG_ANALYZER_AVAIL_Q_CACHE_SIZE = 4 * ZBX_MEBIBYTE;
...
int CONFIG_AUTOCREATE_LIMIT = 10;
// 0 means no limit
...
static void	zbx_load_config()
{
	static struct cfg_line	cfg[] =
	{
		...
		{"StartDBSyncers",		&CONFIG_HISTSYNCER_FORKS,		TYPE_INT,
			PARM_OPT,	1,			100},
        {"StartDBSyncersTrends",		&CONFIG_HISTSYNCER_TRENDS_FORKS,		TYPE_INT,
			PARM_OPT,	1,			100},
        {"StartSyncersUptimes",		&CONFIG_HISTSYNCER_ANALYZER_UPTIMES_FORKS,		TYPE_INT,
			PARM_OPT,	1,			100},
		...
		{"TrendCacheSize",		&CONFIG_TRENDS_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
        {"TrendDbCacheSize",		&CONFIG_TRENDS_DB_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
        {"AnalyzerAvailUptimesCacheSize",		&CONFIG_ANALYZER_AVAIL_UPTIMES_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
        {"AnalyzerAvailPingsCacheSize",		&CONFIG_ANALYZER_AVAIL_PINGS_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
        {"AnalyzerAvailQueueCacheSize",		&CONFIG_ANALYZER_AVAIL_Q_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
...
#	define QUEUE_FEATURE_STATUS	" NO"
	...
	threads_num = CONFIG_CONFSYNCER_FORKS + CONFIG_WATCHDOG_FORKS + CONFIG_POLLER_FORKS
			...
			+ CONFIG_HISTSYNCER_FORKS + CONFIG_HISTSYNCER_TRENDS_FORKS 
            + CONFIG_HISTSYNCER_ANALYZER_UPTIMES_FORKS + CONFIG_ESCALATOR_FORKS
    ...
    else if (server_num <= (server_count += CONFIG_HISTSYNCER_TRENDS_FORKS))
	{
		INIT_SERVER(ZBX_PROCESS_TYPE_HISTSYNCER_TRENDS, CONFIG_HISTSYNCER_TRENDS_FORKS);

        main_dbsyncer_trends_loop();
	}
    else if (server_num <= (server_count += CONFIG_HISTSYNCER_ANALYZER_UPTIMES_FORKS))
	{
		INIT_SERVER(ZBX_PROCESS_TYPE_HISTSYNCER_ANALYZER_UPTIMES, CONFIG_HISTSYNCER_ANALYZER_UPTIMES_FORKS);

        main_dbsyncer_analyzer_loop();
	}
