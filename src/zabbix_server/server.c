...
int CONFIG_ANALYZER_UPTIME_CACHE_SIZE = 2 * ZBX_MEBIBYTE;
int CONFIG_ANALYZER_UPTIME_Q_CACHE_SIZE = 2 * ZBX_MEBIBYTE;
...
static void	zbx_load_config()
{
	static struct cfg_line	cfg[] =
	{
        ...
        {"TrendDbCacheSize",		&CONFIG_TRENDS_DB_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
        {"AnalyzerUptimeCacheSize",		&CONFIG_ANALYZER_UPTIME_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
        {"AnalyzerUptimeQueueCacheSize",		&CONFIG_ANALYZER_UPTIME_Q_CACHE_SIZE,		TYPE_INT,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	ZBX_GIBIBYTE},
...
#	define QUEUE_FEATURE_STATUS	" NO"
    ...
    else if (server_num <= (server_count += CONFIG_HISTSYNCER_ANALYZER_UPTIMES_FORKS))
	{
        ...
        main_dbsyncer_analyzer_uptime_loop();
	}
