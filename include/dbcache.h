...
#define ZBX_SYNC_PARTIAL_HISTORY 2
#define ZBX_SYNC_PARTIAL_TRENDS	3
...
extern int	CONFIG_TRENDS_DB_CACHE_SIZE;
extern int CONFIG_ANALYZER_AVAIL_Q_CACHE_SIZE;
extern int CONFIG_ANALYZER_AVAIL_UPTIMES_CACHE_SIZE;
extern int CONFIG_ANALYZER_AVAIL_PINGS_CACHE_SIZE;
...
extern int CONFIG_AUTOCREATE_LIMIT;
...
int	DCconfig_get_item_by_key(DC_ITEM *item, zbx_uint64_t proxy_hostid, const char *host, const char *key, int skip_calculated_item);
