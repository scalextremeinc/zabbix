...
#define ZBX_PROCESS_TYPE_HISTSYNCER_TRENDS 21
#define ZBX_PROCESS_TYPE_HISTSYNCER_ANALYZER_UPTIMES 22
#define ZBX_PROCESS_TYPE_COUNT		23	/* number of process types */
