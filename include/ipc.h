...
#define ZBX_IPC_ANALYZER_AVAIL_UPTIMES_ID	'u'
#define ZBX_IPC_ANALYZER_AVAIL_PINGS_ID	'p'
#define ZBX_IPC_ANALYZER_AVAIL_UPTIMES_24H_ID	'U'
#define ZBX_IPC_ANALYZER_AVAIL_PINGS_24H_ID	'W'
